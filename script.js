...
alert(
  'Drag the items to move around & click on the items to edit them. To delete the items edit them to blank'
);
// Initialize Arrays
...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Study for masters', 'Sit back and relax'];
    progressListArray = ['Work on projects', 'Listen to music'];
    completeListArray = ['Being normal', 'Getting stuff done'];
    onHoldListArray = ['Being degenerate'];
  }
}
